...
class TestTM(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        # + '<any amount of ones>'
        ntm_transitions: NTMTransitionsT = {
            "q0": {
                "0": {("q0", "0", "R")},
                "1": {("q1", "1", "R"), ("q2", "1", "R")},
            },
        ...
        mntm1_transitions: MNTMTransitionsT = {
            "q0": {
                ("1", "#"): [("q0", (("1", "R"), ("1", "R")))],
                ("0", "#"): [("q0", (("0", "R"), ("#", "N")))],
                ("#", "#"): [("q1", (("#", "N"), ("#", "N")))],
        ...
        mntm2_transitions: MNTMTransitionsT = {
            "q-1": {("#", "#", "#"): [("q0", (("#", "R"), ("#", "N"), ("#", "N")))]},
            "q0": {("0", "#", "#"): [("q1", (("0", "N"), ("#", "R"), ("#", "R")))]},
            "q1": {("0", "#", "#"): [("q2", (("0", "N"), ("0", "R"), ("#", "N")))]},
            "q2": {("0", "#", "#"): [("qc", (("0", "N"), ("#", "L"), ("X", "R")))]},
        ...
        mntm3_transitions: MNTMTransitionsT = {
            "q0": {
                ("0", "#", "#"): [("q1", (("0", "N"), ("$", "R"), ("$", "R")))],
                ("1", "#", "#"): [("q1", (("1", "N"), ("$", "R"), ("$", "R")))],
            },
