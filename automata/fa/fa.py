...
try:
    ...
    from automata.base.animation import Animate, _ManimEdge, _ManimNode
except ImportError:
...
if _visual_imports:
    ...
    class _FAGraph(manim.VDict):
        ...
        def __init__(self, fa: FA):
            """
            Generate the graph and put it on the down side o the screen.
            ...
            super().__init__(
                {
                    name_state.get(node): _ManimNode(node)
